...
#####################################################
PIC_DIR = '/mnt/photos/Photos' #'textures'
#PIC_DIR = '/mnt/photos/test' #'textures'
#PIC_DIR = '/bigcheese/Pictures/test' #'textures'
  ...
  try:
    ...
    def on_message(client, userdata, message):
      ...
      if message.topic == "frame/date_from": # NB entered as mqtt string "2016:12:25"
        ...
        print('quitting Received message!' + iFiles[pic_num][0])
        quit = True
      elif message.topic == "frame/print":
        shutil.copy2(iFiles[pic_num][0], '/bigcheese/Pictures/TOPRINT/')  
      elif message.topic == "frame/delete":
        shutil.move(iFiles[pic_num][0], '/bigcheese/Pictures/TODELETE/')  
    ...
    client.connect("localhost", 1883, 60) # replace with your own server
    client.loop_start()
    ...
    client.subscribe("frame/print", qos=0)
